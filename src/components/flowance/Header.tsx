  ...
  return (
    <header className="header">
      ...
      <div className="header-right">
        <button className="icon-btn" style={{ display: 'none' }} onClick={h(`openScanSheet('voice')`)} title="إضافة بالصوت" aria-label="إضافة بالصوت">
        ...
        <button className="icon-btn" style={{ display: 'none' }} onClick={h(`openHistorySheet()`)} title="سجل الشهور" aria-label="سجل الشهور">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
