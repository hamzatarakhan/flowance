  ...
  return (
    <div className="budget-card">
      ...
      <div className="budget-hero">
        <span className="budget-hero-lbl" id="budgetHeroLbl">المتبقي من الميزانية</span>
        <div className="budget-hero-row">
          <span className="budget-hero-num" id="budgetHeroNum">0.000</span>
          <span className="budget-hero-cur">JOD</span>
        </div>
        <span className="budget-hero-daily" id="budgetDaily"></span>
      </div>
